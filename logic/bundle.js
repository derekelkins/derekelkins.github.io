var ndjs = (function (exports) {
    ...
    */
    ...
    var derivationFromHash = function () {
        try {
            var derivationJson = JSON.parse(decodeURIComponent(location.hash.slice(1)));
